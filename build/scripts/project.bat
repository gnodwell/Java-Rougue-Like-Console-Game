...
set CLASSPATH=%APP_HOME%\lib\project.jar;%APP_HOME%\lib\json-simple-1.1.1.jar;%APP_HOME%\lib\lanterna-3.0.3.jar;%APP_HOME%\lib\junit-4.10.jar;%APP_HOME%\lib\hamcrest-core-1.1.jar


@rem Execute project
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %PROJECT_OPTS%  -classpath "%CLASSPATH%" rogue.WindowUI %CMD_LINE_ARGS%
